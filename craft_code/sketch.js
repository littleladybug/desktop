...
function setup() {
  ...
  hands.push(new Hand(width / 2, height / 5, 40, 0, 0.55));
  hands.push(new Hand(width / 2, height / 5, 50, 1, 0.66));
  hands.push(new Hand(width / 3, height / 4, 70, 2, 0.6));
  hands.push(new Hand(width / 5, height / 3, 50, 3, 0.5));
...
function draw() {
  if (level == 1) {
    ...
    function segment(x, y, a) {
     ...
     if ((mouseIsPressed) && mouseX < 50 && mouseY > 700) {
      level = 2;
    }
  }
  if (level == 5) {
    ...
    if ((mouseIsPressed) && mouseX > 40 && mouseY > 10) {
      image(loopstitch, mouseX - 50, mouseY - 20);
    } else if ((mouseIsPressed) && mouseX < 40 && mouseY < 40) {
      level = 2;
    }
  }

  if (level == 4) {
    background(bkrnd1, 1024, 760);
    image(vid, 180, 120);
    image(icon, 10, 680);
    image (frame, 0,0);
  ...
  if (level == 0) {
    ...
    image(title, 330, 210);
    image(jayne, 780, 390);
    image(enter, 1200, 660); //MAKE THIS PART WRITTEN!
